...
type Warden interface {
	// IsAllowed returns nil if subject s can perform action a on resource r
	// with context c or an error otherwise.
	//  if err := guard.IsAllowed(&Request{Resource: "article/1234",
	//		Action: "update", Subject: "peter"}); err != nil {
